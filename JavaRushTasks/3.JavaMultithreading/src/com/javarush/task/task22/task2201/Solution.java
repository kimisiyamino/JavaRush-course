...
public class Solution {
    ...
    public synchronized String getPartOfString(String string, String threadName) {
         ...
         }else if(string == null || string.equals("") || threadName == null){
        ...
        if(firstTab == -1 || lastTab == -1 || firstTab == lastTab){throw new RuntimeException(new StringIndexOutOfBoundsException("String index out of range: -1"));}
