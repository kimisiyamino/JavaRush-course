...
//        } while (operation != Operation.EXIT);
        //Path path = Paths.get("D:\\JavaRush\\JavaRushTasks\\3.JavaMultithreading\\src\\com\\javarush\\task\\task31\\task3110");
       // FileManager fileManager = new FileManager(path);
        //fileManager.collectFileList(path);
       // System.out.println(fileManager.getFileList().toString());
    }
